...
function Zw takes nothing returns nothing
	...
	call CreateTextTagLocBJ("决战江湖1.6.17名人榜",GetRectCenter(uh),100.,$A,100,100,.0,50.)
	...
	call DisplayTimedTextToForce(bj_FORCE_ALL_PLAYERS,30,"|cfffff000欢迎来到|cffff00de金庸群侠传之决战江湖1.6.17|r")
	// 获取服务器全局存档，信息提示
